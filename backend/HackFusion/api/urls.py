...
urlpatterns = [
    ...
    path("pdf-chat/upload/", upload_and_process_pdfs, name="pdf-upload"),
    path("pdf-chat/<str:session_id>/ask/", ask_question, name="pdf-ask"),
    path("pdf-chat/<str:session_id>/files/", get_session_pdfs, name="pdf-files"),
]
