...
const UsersList = () => {
    ...
    return (
        <>
            ...
            {/* Main container */}
            <div
    className={`lg:px-8 px-6 py-6 transition-all ${isSidebarOpen ? "md:ml-[20%]" : "md:ml-[10%]"
        } duration-300 w-full mx-auto md:w-full lg:w-3/4`}
    style={{ height: "100vh", overflow: "hidden", backgroundColor: "#0a0a0a" }}
>
    ...
    <input
        ...
        className="w-full p-3 mb-4 bg-[#141414] text-white rounded-lg focus:outline-none focus:ring-2 focus:ring-white transition duration-300"
    />
                ...
                {filteredUsers.length > 0 ? (
                    <ul className="list-none p-0">
                        {filteredUsers.map((user) => (
                            <li
                                key={user.id}
                                className="flex justify-between items-center p-4 mb-4 bg-[#141414] rounded-lg shadow-lg transition duration-300"
                            >
                                <div
                                ...
                                <button
                                    ...
                                    className="px-4 py-2 bg-white hover:bg-gray-300 text-black font-semibold rounded-lg transition duration-300"
                                >
                                    Invite
                                </button>
                            </li>
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center">
        <div className="bg-[#0a0a0a] p-6 rounded-lg shadow-lg w-96">
                    ...
                    {myTeams.map((team) => (
                        <li key={team.id} className="flex justify-between items-center p-3 bg-[#141414] rounded-lg">
                            ...
                            <button
                                ...
                                className="px-3 py-1 bg-white hover:bg-gray-300 text-black font-semibold rounded transition duration-300"
                            >
                                Invite
                            </button>
                        </li>
            ...
            <button
                onClick={closeModal}
                className="mt-4 px-4 py-2 bg-white hover:bg-gray-300 text-black font-semibold rounded-lg w-full transition duration-300"
            >
                Cancel
            </button>
        </div>
