    ...
    <div id="nav-bar">
      ...
      <div id="nav-content">
        ...
        <div
          ...
          onClick={() => navigate(`/recommended-content`)}
        >
        ...
        <hr />
        {/* === NEW LINK ADDED HERE === */}
        <div className="nav-button" onClick={() => navigate("/uploadpdf")}>
          <i className="fas fa-comments"></i> {/* AI Chat icon */}
        ...
        <Link to={`/user/${user?.id}`}>
          <div id="nav-footer-heading" className="flex items-center gap-3">
            <div
              ...
              className="w-12 h-12 overflow-hidden rounded-full border-2 border-gray-300"
            >
              <img
                src={profile?.avatar}
                alt="Avatar"
